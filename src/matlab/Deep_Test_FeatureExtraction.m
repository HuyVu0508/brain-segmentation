function [feature0,indx0] = Deep_Test_FeatureExtraction(data,numofdata,featureopen,b,typeoffeature)
    feature0 = {};
    indx0 = {};
    sumnumofpositive = 0;
    for i=1:numofdata
...
%         positiveSamples = data{i}.S.Difference_LowProba_Open_CSF;
        ...
        [ft,td] = Deep_Test_FeatureExtraction_WholeBrain(Mask,T1,featureopen,b,typeoffeature);
...
function [feature,td] = Deep_FeatureExtraction_WholeBrain(Mask,T1,brainregion,featureopen,b,typeoffeature)
%     Input:
